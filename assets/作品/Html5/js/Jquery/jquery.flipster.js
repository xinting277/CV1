    ...
    $.fn.flipster = function (options) {
        ...
        return this.each(function () {
            ...
            function jump(to) {
                ...
                if (settings.angle) {
                    $('.flipster--coverflow .flipster__item--current .flipster__item__content').css({
                        '-webkit-transform': 'rotateY(0deg)',
                        'transform': 'rotateY(0deg)'
                    });

                    $('.flipster--coverflow .flipster__item--past .flipster__item__content').css({
                        '-webkit-transform': 'scale(1) rotateY(' + settings.angle + 'deg)',
                        'transform': 'scale(1) rotateY(' + settings.angle + 'deg)'
                    });

                    $('.flipster--coverflow .flipster__item--future .flipster__item__content').css({
                        '-webkit-transform': 'scale(1) rotateY(-' + settings.angle + 'deg)',
                        'transform': 'scale(1) rotateY(-' + settings.angle + 'deg)'
                    });
                }
            ...
            function init() {
                ...
                if (images.length) {
                    ...
                    setTimeout(function () {
                        ...
                        var block = $(self).children()[0];
                        $(block).css({
                            position: 'absolute',
                            left: 0,
                            top: ($(self).height() - $(block).height()) / 2
                        });
                    }, 750);
                } else {
                    show();
