                                    ...
                                    case 'BrushObjectFormatter':
                                        ...
                                        ebookjson = {
                                            ...
                                            object: {
                                                ...
                                                opacity: getOpacity($(this).attr('ForeColor'))
                                            },
                                            page: MainObj.NowPage,
...
function FindPenSize(points, obj) {
    ...
    var ListX = pointX.sort(function (a, b) {
        return a - b;
    });
    var minX = ListX[0];
    var maxX = ListX[ListX.length - 1];

    var ListY = pointY.sort(function (a, b) {
        return a - b;
    });
    var minY = ListY[0];
    var maxY = ListY[ListY.length - 1];

    var width = (maxX - minX) * scale + penwidth * 2;
    var height = (maxY - minY) * scale + penwidth * 2;
    var left = minX * scale - penwidth;
    var top = minY * scale - penwidth;
